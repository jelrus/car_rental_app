...
@WebServlet("/moderator/management/order/")
public class OrderInfoServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_MANAGER) {
            orderControllerUtil.infoOrderManagerGet(req);
            getServletContext().getRequestDispatcher("/moderator/management/order-info.jsp").forward(req, resp);
        } else {
