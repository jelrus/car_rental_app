...
@WebServlet("/admin/personal/order/")
public class AdminOrderInfoServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            ...
            getServletContext().getRequestDispatcher("/admin/personal/order-info.jsp").forward(req, resp);
        } else {
