...
@WebServlet("/admin/management/manager/")
public class ManagerInfoServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            ...
            req.getRequestDispatcher("/admin/management/manager-info.jsp").forward(req, resp);
        } else {
