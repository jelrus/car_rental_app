...
@WebServlet("/admin/management/users/hide/")
public class UserHideServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            userControllerUtil.hideUserPost(req);
            resp.sendRedirect("/admin/management/users");
        } else {
