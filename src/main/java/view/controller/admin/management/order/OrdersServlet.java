...
@WebServlet("/admin/management/orders")
public class OrdersServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            orderControllerUtil.ordersAdminGet(req);
            getServletContext().getRequestDispatcher("/admin/management/orders.jsp").forward(req, resp);
        } else {
