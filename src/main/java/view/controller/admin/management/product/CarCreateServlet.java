...
@WebServlet("/admin/product/car/create/new")
public class CarCreateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            carControllerUtil.createCarGet(req);
            getServletContext().getRequestDispatcher("/admin/management/car-create.jsp").forward(req, resp);
        } else {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            carControllerUtil.createCarPost(req);
