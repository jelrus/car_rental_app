...
@WebServlet("/admin/product/cars")
public class CarsServlet extends AbstractServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            carControllerUtil.carsGetAdmin(req);
            getServletContext().getRequestDispatcher("/admin/management/cars.jsp").forward(req, resp);
        } else {
