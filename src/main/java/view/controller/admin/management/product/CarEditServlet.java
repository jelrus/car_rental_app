...
@WebServlet("/admin/product/edit/car/")
public class CarEditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            carControllerUtil.editCarGet(req);
            req.getRequestDispatcher("/admin/management/car-edit.jsp").forward(req, resp);
        } else {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.requireNonNull(user).getRoleType() == RoleType.ROLE_ADMIN) {
            resp.sendRedirect("/admin/product/car/?id=" + carControllerUtil.editCarPost(req).getId());
        } else {
            resp.sendRedirect("/nowhere");
        }
    }
