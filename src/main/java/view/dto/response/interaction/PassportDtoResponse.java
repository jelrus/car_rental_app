...
public class PassportDtoResponse extends DtoResponse {
    ...
    public PassportDtoResponse(Passport passport) {
        ...
        setStreet(passport.getStreet());
        setBuilding(passport.getBuilding());
        setPhoneNumber(passport.getPhoneNumber());
        setEmail(passport.getEmail());
    }
