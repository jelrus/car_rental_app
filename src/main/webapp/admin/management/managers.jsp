...
<html>
<head>
    <title>Managers Management</title>
</head>
                ...
                <div class="card" id="card-main-table">
                    <div class="card-body">
                        <table class="table table-sm table-hover" id="hover-main-table">
                            ...
                            <tbody>
                            <c:forEach items="${pageData.items}" var="manager">
                                <tr>
                                    <td>${manager.created}</td>
                                    <td>${manager.updated}</td>
                                    <td>${manager.username}</td>
                                    <td>
                                        <a class="btn btn-warning" href="${pageContext.request.contextPath}/admin/management/manager/?id=${manager.id}">Info</a>
                                    </td>
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/management/managers/hide/?id=${manager.id}"
                                              method="post" id="hide-form">
                                            <c:if test="${manager.enabled == true}">
                                                <button class="btn btn-danger"
                                                        type="submit">Hide</button>
                                            </c:if>
                                            <c:if test="${manager.enabled == false}">
                                                <button class="btn btn-danger"
                                    ...
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/management/managers/delete/?id=${manager.id}"
                            ...
                            <div class="d-flex justify-content-end align-items-center">
                                ...
                                <div class="p-1">
                                    <a class="page-link btn btn-secondary" id="new"
                                       href="${pageContext.request.contextPath}/admin/management/manager/new"
                                       title="Create new manager"><i class="fa fa-solid fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
