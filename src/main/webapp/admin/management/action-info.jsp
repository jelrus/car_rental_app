...
<div class="card" id="dashboard-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/admin/management/action/?id=${action.id}" id="action-info-nav-link">
    ...
    <div class="row row-cols-6" id="info-menu-card-body">
        ...
        <div class="col-menu">
            <div class="card" id="personal-menu-card-info">
                <div class="row-menu">
                    <a href="${pageContext.request.contextPath}/admin/management/action/?id=${action.id}" class="custom-am-header">
    ...
    <div id="div-edit">
        <div class="col-menu" id="edit-header">
            <a href="${pageContext.request.contextPath}/admin/management/edit/action/?id=${action.id}" class="custom-am">
