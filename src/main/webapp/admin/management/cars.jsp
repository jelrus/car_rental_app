                ...
                <div class="card" id="card-main-table">
                    <div class="card-body">
                        <table class="table table-sm table-hover" id="hover-main-table">
                            ...
                            <tbody>
                            <c:forEach items="${pageData.items}" var="car">
                                <tr>
                                    <td>${car.created}</td>
                                    <td>${car.updated}</td>
                                    <td>${car.title}</td>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="${pageContext.request.contextPath}/admin/product/car/?id=${car.id}">Info</a>
                                    </td>
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/product/cars/hide/?id=${car.id}"
                                              method="post" id="hide-form">
                                            <c:if test="${car.enabled == true}">
                                                <button class="btn btn-danger"
                                                        type="submit">Hide</button>
                                            </c:if>
                                            <c:if test="${car.enabled == false}">
                                                <button class="btn btn-danger"
                                    ...
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/product/cars/delete/?id=${car.id}"
                            ...
                            <div class="d-flex justify-content-end align-items-center">
                                ...
                                <div class="p-1">
                                    <a class="page-link btn btn-secondary" id="new"
                                       href="${pageContext.request.contextPath}/admin/product/car/create/new"
                                       title="Create new car"><i class="fa fa-solid fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
