...
<div class="card" id="manager-edit-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/admin/management/manager/?id=${bUser.id}" id="action-info-nav-link">
            <div class="card" id="dashboard-menu-nav-card-action-info">Manager Profile</div>
        </a>
        <a href="${pageContext.request.contextPath}/admin/management/edit/manager/?id=${bUser.id}"
           id="action-edit-nav-link">
            <div class="card" id="dashboard-menu-nav-card-action-edit">Manager Editor</div>
        </a>
    </nav>
