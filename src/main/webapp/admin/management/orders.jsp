...
<jsp:useBean id="actionFacade" scope="request" type="facade.relation.OrderActionsFacade"/>
...
<div class="card" id="dashboard-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/admin/management/orders" id="actions-nav-link">
            <div class="card" id="dashboard-menu-nav-card-actions">Management Orders</div>
        </a>
    </nav>
                ...
                <div class="card" id="card-main-table">
                    <div class="card-body">
                        <table class="table table-sm table-hover" id="hover-main-table">
                            ...
                            <tbody>
                            <c:forEach items="${pageData.items}" var="order">
                                <tr>
                                    <td>${order.created}</td>
                                    <td>${order.updated}</td>
                                    <td>${order.start}</td>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="${pageContext.request.contextPath}/admin/management/order/?id=${order.id}">Info</a>
                                    </td>
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/management/orders/hide/?id=${order.id}"
                                              method="post" id="hide-form">
                                            <c:if test="${order.enabled == true}">
                                                <button class="btn btn-danger"
                                                        type="submit">Hide</button>
                                            </c:if>
                                            <c:if test="${order.enabled == false}">
                                                <button class="btn btn-danger"
                                    ...
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/management/orders/delete/?id=${order.id}"
