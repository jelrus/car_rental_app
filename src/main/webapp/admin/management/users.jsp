...
<div class="card" id="dashboard-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/admin/management/users" id="actions-nav-link">
                ...
                <div class="card" id="card-main-table">
                    <div class="card-body">
                        <table class="table table-sm table-hover" id="hover-main-table">
                            ...
                            <tbody>
                            <c:forEach items="${pageData.items}" var="baseUser">
                                <tr>
                                    <td>${baseUser.created}</td>
                                    <td>${baseUser.updated}</td>
                                    <td>${baseUser.username}</td>
                                    <td>
                                        <a class="btn btn-warning" href="${pageContext.request.contextPath}/admin/management/user/?id=${baseUser.id}">Info</a>
                                    </td>
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/management/users/hide/?id=${baseUser.id}"
                                              method="post" id="hide-form">
                                            <c:if test="${baseUser.enabled == true}">
                                                <button class="btn btn-danger"
                                                        type="submit">Hide</button>
                                            </c:if>
                                            <c:if test="${baseUser.enabled == false}">
                                                <button class="btn btn-danger"
                                    ...
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/management/users/delete/?id=${baseUser.id}"
                        ...
                        <div class="d-flex justify-content-end" id="pagination-menu">
                            <div class="d-flex justify-content-end align-items-center">
                                ...
                                <div class="p-1">
                                    <a class="page-link btn btn-secondary" id="new"
                                       href="${pageContext.request.contextPath}/admin/management/user/new"
                                       title="Create new user"><i class="fa fa-solid fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
