...
<div class="card" id="personal-info-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/admin/management/users" id="users-nav-link">
            <div class="card" id="dashboard-menu-nav-card-users">Users</div>
        </a>
        <a href="${pageContext.request.contextPath}/admin/management/user/?id=${bUser.id}" id="user-nav-link">
            <div class="card" id="dashboard-menu-nav-card-user">User Profile</div>
        </a>
    </nav>
