...
<div class="card" id="edit-profile-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/admin/personal/profile" id="actions-nav-link">
            <div class="card" id="dashboard-menu-nav-card-actions">My Profile</div>
        </a>
        <a href="${pageContext.request.contextPath}/admin/personal/profile/edit/" id="edit-profile-nav-link">
