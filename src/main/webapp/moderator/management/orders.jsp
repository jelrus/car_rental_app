...
<div class="card" id="dashboard-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/moderator/management/orders" id="actions-nav-link">
                        ...
                        <table class="table table-sm table-hover" id="hover-main-table">
                            ...
                            <c:forEach items="${pageData.items}" var="order">
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="${pageContext.request.contextPath}/moderator/management/order/?id=${order.id}">Info</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
