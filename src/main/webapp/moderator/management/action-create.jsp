...
<div class="card" id="dashboard-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/moderator/management/orders" id="orders-nav-link">
            <div class="card" id="dashboard-menu-nav-card-orders">Orders</div>
        </a>
        <a href="${pageContext.request.contextPath}/moderator/management/order/?id=${order.id}" id="order-nav-link">
            <div class="card" id="dashboard-menu-nav-order">Order</div>
        </a>
        <a href="${pageContext.request.contextPath}/moderator/management/action/new/?orderId=${order.id}" id="action-new-nav-link">
