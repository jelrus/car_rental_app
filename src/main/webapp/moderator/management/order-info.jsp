...
<div class="card" id="dashboard-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/moderator/personal/orders" id="orders-nav-link">
            <div class="card" id="dashboard-menu-nav-card-orders">Orders</div>
        </a>
        <a href="${pageContext.request.contextPath}/moderator/personal/order/?id=${order.id}" id="order-nav-link">
            ...
            <div class="card">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                    <div class="card-body" id="card-accordion-body-4">
                        <div class="col"></div>
                        <div class="row">
                            <div class="col" id="add-action">
                                <a href="${pageContext.request.contextPath}/moderator/management/action/new/?orderId=${order.id}"
                                   class="custom-am" id="action-table-link">
