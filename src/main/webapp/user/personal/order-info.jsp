...
<div class="card" id="dashboard-main-card">
    ...
    <nav class="navbar navbar-expand-lg" id="dashboard-menu-nav">
        ...
        <a href="${pageContext.request.contextPath}/user/personal/orders" id="orders-nav-link">
            <div class="card" id="dashboard-menu-nav-card-orders">Orders</div>
        </a>
        <a href="${pageContext.request.contextPath}/user/personal/order/?id=${order.id}" id="order-nav-link">
